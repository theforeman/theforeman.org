...
* In Global Registration, using another LANG like pt_BR.UTF-8 breaks the UUID ([#35051](https://projects.theforeman.org/issues/35051))
...
#### Foreman - Tests
* Update show_me_the_cookies dependency to 6.x ([#35371](https://projects.theforeman.org/issues/35371))
...
#### Packaging - RPMs
* Sendmail binary is not present on EL8 and needs manual configuration ([#35461](https://projects.theforeman.org/issues/35461))

#### Smart Proxy - Packaging
* Declare compatible versions of Sinatra  ([#35507](https://projects.theforeman.org/issues/35507))

*A full list of changes in 3.3.1 is available via [Redmine](https://projects.theforeman.org/issues?set_filter=1&sort=id%3Adesc&status_id=closed&f[]=cf_12&op[cf_12]=%3D&v[cf_12]=1600)*
