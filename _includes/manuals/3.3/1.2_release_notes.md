...
* Remove Share your feedback link in new host page
 ([#34841](https://projects.theforeman.org/issues/34841))
* Add host page reports tab  ([#34782](https://projects.theforeman.org/issues/34782))
* Add developer documentation for pagelets ([#34544](https://projects.theforeman.org/issues/34544))
* Host list page should show the host comment ([#34516](https://projects.theforeman.org/issues/34516))
* Host list page should show the owner of the host ([#34515](https://projects.theforeman.org/issues/34515))

#### Foreman - API
* Taxonomies api dont accept per_page all ([#34748](https://projects.theforeman.org/issues/34748))
...
#### Foreman - Audit Log
* Add rake that print out documentation of Auditable attributes ([#34690](https://projects.theforeman.org/issues/34690))
...
#### Foreman - Inventory
* Submit button on Edit page of a host will revert back to a invalid page on Satellite ([#34830](https://projects.theforeman.org/issues/34830))
...
* Remove pf3 OverlayTrigger ([#34713](https://projects.theforeman.org/issues/34713))
...
* Create pf4 breadcrumb switcher ([#34290](https://projects.theforeman.org/issues/34290))
...
#### Foreman - Statistics
* Host - Last Checkin report template is not showing any other content host apart from Red Hat Satellite itself.
 ([#34809](https://projects.theforeman.org/issues/34809))
...
* installer spams with katello-certs-check output when using custom certs
 ([#34888](https://projects.theforeman.org/issues/34888))
...
* Should update oauth Gem installed by puppet-agent-oauth under Debian to a newer version (0.5.1 produces lots of warnings about URI.escape) ([#34681](https://projects.theforeman.org/issues/34681))

#### Packaging - RPMs
* foreman.rpm pulls in nodejs ([#34507](https://projects.theforeman.org/issues/34507))
* instaler uses hostname, but that package can be absent ([#34468](https://projects.theforeman.org/issues/34468))
