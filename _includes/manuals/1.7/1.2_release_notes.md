...
<div id="modalSCParamMerges" class="modal modal-video hide fade" tabindex="-1" role="dialog" aria-labelledby="modalSCParamMergesLabel" aria-hidden="true" style="width: 700px; margin-left:-320px;">
...
<div id="modalSCParamOverrides" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalSCParamOverridesLabel" aria-hidden="true" style="width: 700px; margin-left:-320px;">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
...
New buttons have been added to the Puppet class list to quickly override all smart class parameters, or reset them to default values in a single click.  This is accessible from the dropdown menu to the right of each class.  Click the YouTube icon to the left for a short demonstration.

#### Host creation: Build review page

<div id="modalBuildReview" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modalBuildReview" aria-hidden="true" style="width: 700px; margin-left:-320px;">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
