...
<div class="quickstart_os quickstart_os_rhel6 quickstart_os_el6 quickstart_os_rhel7 quickstart_os_el7 quickstart_os_fedora19 alert alert-info">
Due to a bug (<a href="http://projects.theforeman.org/issues/9916">link</a>), Foreman's installer is incompatible with the newly released Puppet 3.7.5.  The command below explicitly installs Puppet 3.7.4 in the meantime.
</div>
...
{% highlight bash %}
yum -y install puppet-3.7.4 foreman-installer
{% endhighlight %}
</div>

<div class="quickstart_os quickstart_os_debian7 quickstart_os_ubuntu1204 quickstart_os_ubuntu1404">
{% highlight bash %}
apt-get update && apt-get -y install puppet=3.7.4-1puppetlabs1 puppet-common=3.7.4-1puppetlabs1 foreman-installer
{% endhighlight %}
</div>
