...
Restart the application on the nodes running the application server
(e.g. mongrel, thin, passenger).
...
Restart the smart-proxy on the smart-proxies nodes (probably including your
application server).

    service foreman-proxy restart

Please note that you need to follow the same upgrade procedure for each of your
smart proxies nodes.
