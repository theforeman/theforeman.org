...
1. Copy [external_node_v2.rb.erb](https://raw.github.com/theforeman/puppet-foreman/2.1-stable/templates/external_node_v2.rb.erb) to the Puppet configuration directory, e.g. '/etc/puppet'
