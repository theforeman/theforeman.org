...
* Host details templates card ([#35387](https://projects.theforeman.org/issues/35387))
...
* Host UI - box & cursor pointer ([#35319](https://projects.theforeman.org/issues/35319))
* New host detail - OS label as a link to OS detail ([#35305](https://projects.theforeman.org/issues/35305))
* Details tab - Switch to masonry card layout instead of square grid ([#35294](https://projects.theforeman.org/issues/35294))
* Hosts "New UI" no way to review templates ([#35176](https://projects.theforeman.org/issues/35176))
* Fix details tab cards Expand/collapse all behavior ([#34997](https://projects.theforeman.org/issues/34997))
* refactor filters page  ([#34764](https://projects.theforeman.org/issues/34764))
