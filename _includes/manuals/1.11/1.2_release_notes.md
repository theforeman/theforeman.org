...
#### API
* Fix performance of loading permissions lists in host show API for non-admin users ([#15527](http://projects.theforeman.org/issues/15527))

#### Installer and packaging
* Pin rabl to 0.12.x ([#15712](http://projects.theforeman.org/issues/15712))

#### Security
* Fix unrestricted access to host interfaces and parameters APIs ([CVE-2016-5390](/security.html#2016-5390), [#15653](http://projects.theforeman.org/issues/15653))
* Fix unrestricted access to host provisioning template previews ([CVE-2016-4995](/security.html#2016-4995), [#15490](http://projects.theforeman.org/issues/15490))
* Fix UI/API privilege escalation allowing users to view, edit and delete other org/locations ([CVE-2016-4475](/security.html#2016-4475), [#15268](http://projects.theforeman.org/issues/15268))

#### Web Interface
* Fix SQL error when viewing details of a trend ([#15570](http://projects.theforeman.org/issues/15570))

#### Various fixes and features
* Fix configuration of SELinux policy for OpenStack service ports on RHEL 6 ([#15639](http://projects.theforeman.org/issues/15639))

*A full list of changes in 1.11.4 is available via [Redmine](http://projects.theforeman.org/rb/release/169)*
...
*A full list of changes in 1.11.3 is available via [Redmine](http://projects.theforeman.org/rb/release/159)*

### Release notes for 1.11.2

#### API
* Document password parameter of compute resource images ([#14701](http://projects.theforeman.org/issues/14701))
* Fix loading of host facet extensions, resolves foreman_hooks missing data ([#14981](http://projects.theforeman.org/issues/14981))
* Fix smart parameter overrides 'value' parameter to not be required ([#14927](http://projects.theforeman.org/issues/14927))

#### Authentication and Authorization
* Fix editing of hosts by users without edit_params permissions ([#14795](http://projects.theforeman.org/issues/14795))

#### CLI
* Add Hammer CLI autocomplete to Debian packages ([#7087](http://projects.theforeman.org/issues/7087))

#### Compute resources and Hosts creation
* Fix sh/POSIX compatibility when running finish scripts during image provisioning ([#14957](http://projects.theforeman.org/issues/14957))
* Fix private method error using AutoYaST iPXE template ([#15009](http://projects.theforeman.org/issues/15009))
* Fix GRUB installation question using preseed with Ubuntu 16.04 ([#14844](http://projects.theforeman.org/issues/14844))
* Fix datacenter path error cloning VMware images ([#14874](http://projects.theforeman.org/issues/14874))
* Fix error listing oVirt templates without sub version ([#11079](http://projects.theforeman.org/issues/11079))
* Fix oVirt network name shown in host interfaces table description ([#15020](http://projects.theforeman.org/issues/15020))

#### Installer and packaging
* Fix path to Ruby interpreter in Ubuntu 14.04 package init script ([#14734](http://projects.theforeman.org/issues/14734))
* Fix cleanup of Gemfile.lock on Debian package removal ([#5539](http://projects.theforeman.org/issues/5539))
...
* puppetlabs-apache, backport to 1.8.x of support for Ubuntu 16.04
* puppetlabs-mysql, backport to 3.7.x of support for Ubuntu 16.04
* puppetlabs-postgresql, backport to 4.7.x of support for Ubuntu 16.04

#### Proxy and Services
* Add DNS record checking utility functions for DNS provider plugins ([#13942](http://projects.theforeman.org/issues/13942))
* Fix subnets filtering setting when using ISC DHCP provider ([#14952](http://projects.theforeman.org/issues/14952))
* Fix missing FreeIPA permissions for removal of DNS records ([#10015](http://projects.theforeman.org/issues/10015))
* Fix missing log buffer sizes in log message during startup ([#15028](http://projects.theforeman.org/issues/15028))
* Pin webmock for Ruby 1.8 support ([#14862](http://projects.theforeman.org/issues/14862))

#### Puppet and Puppet integration
* Fix fact name already taken error during fact imports ([#13819](http://projects.theforeman.org/issues/13819))
* Fix display of smart parameter values in host creation after OS and domain selection ([#14790](http://projects.theforeman.org/issues/14790))

#### Security
* Fix arbitrary remote code execution in smart proxy TFTP API ([CVE-2016-3728](/security.html#2016-3728), [#14931](http://projects.theforeman.org/issues/14931))
* Add paths of Passenger binaries to SELinux policy for new EPEL7 Passenger builds ([#14811](http://projects.theforeman.org/issues/14811))
* Permit connections to OpenStack compute service in SELinux policy ([#10443](http://projects.theforeman.org/issues/10443))

#### Web Interface
* Fix cache sweeper error when deleting users under orgs/locations ([#14735](http://projects.theforeman.org/issues/14735))
* Fix compute resource details Deface error with foreman_docker on EL6 ([#14769](http://projects.theforeman.org/issues/14769))
* Fix smart proxy latest events widget to show only events from one proxy ([#14748](http://projects.theforeman.org/issues/14748))
* Fix visible template type dropdown menu when creating snippets ([#14855](http://projects.theforeman.org/issues/14855))
* Fix missing search functionality on compute profile list ([#14744](http://projects.theforeman.org/issues/14744))
* Fix disabled delete buttons for host interfaces to be fully disabled ([#14726](http://projects.theforeman.org/issues/14726))
* Fix user editing to not show unsaved, invalid usernames in the menu ([#14691](http://projects.theforeman.org/issues/14691))
* Fix smart proxy Puppet CA tabbing method to be more compatible with plugins ([#14679](http://projects.theforeman.org/issues/14679))
* Fix redirection during forced user login to remember the page URL ([#14072](http://projects.theforeman.org/issues/14072))
* Fix display of long bookmark names ([#14376](http://projects.theforeman.org/issues/14376))
* Fix display of long smart proxy names ([#14768](http://projects.theforeman.org/issues/14768))

#### Various fixes and features
* Add id to org/location search to allow searching from CLI ([#14686](http://projects.theforeman.org/issues/14686))
* Support running Foreman under Ruby 2.3 ([#14840](http://projects.theforeman.org/issues/14840))
* Fix application logger to follow log level from settings.yaml ([#14820](http://projects.theforeman.org/issues/14820))
* Fix prod2dev rake task compatibility with Rails 4 ([#14866](http://projects.theforeman.org/issues/14866))
* Fix escaped config rake task output of array settings ([#14778](http://projects.theforeman.org/issues/14778))
* Fix free text host search error when smart proxies are excluded from orgs/locations ([#14730](http://projects.theforeman.org/issues/14730))
* Fix auditing extension load order to fix upgrade error ([#14965](http://projects.theforeman.org/issues/14965))
* Fix class naming error running integration test suite ([#14810](http://projects.theforeman.org/issues/14810))

*A full list of changes in 1.11.2 is available via [Redmine](http://projects.theforeman.org/rb/release/155)*
