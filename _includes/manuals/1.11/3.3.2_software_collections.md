...
A "tfm" (The Foreman) collection is provided by the Foreman project which ships all dependencies for the main Foreman application, and depends on the standard "rh-ror41", "rh-ruby22" and "v8314" collections which provide Ruby 1.9.3 and Ruby on Rails 3.2.  Packages that are part of these collections will have "tfm-", "rh-ror41-", "rh-ruby22-" and "v8314-" prefixes, allowing them to be easily identified, and will install entirely underneath `/opt/theforeman` and `/opt/rh`.
