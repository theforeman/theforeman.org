...
* Fix unrecognized us-east-2 (Ohio) EC2 region ([#17781](http://projects.theforeman.org/issues/17781))

#### Proxy and Services
* Fix DNS record deletion failure with MS DHCP provider returning non-JSON response ([#17823](http://projects.theforeman.org/issues/17823))

#### Web Interface
* Fix internal server error when editing templates in Internet Explorer ([#17808](http://projects.theforeman.org/issues/17808))

*A full list of changes in 1.13.4 is available via [Redmine](http://projects.theforeman.org/rb/release/213)*
