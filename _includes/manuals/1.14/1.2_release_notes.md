...
* Rename `use_puppet_default` to `skip_foreman` on smart variables ([#15846](http://projects.theforeman.org/issues/15846))
...
* `use_puppet_default` on smart variable overrides should be replaced by `skip_foreman` in both API parameters and responses.
