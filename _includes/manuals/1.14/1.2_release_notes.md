...
#### API
* Fix high database CPU usage through joins when loading API indexes ([#18843](http://projects.theforeman.org/issues/18843))
* Fix inheritance of facet attributes in host creation API ([#18800](http://projects.theforeman.org/issues/18800))

#### Authentication and Authorization
* Fix authorization checks for non-admin users editing global parameters ([#18722](http://projects.theforeman.org/issues/18722))
* Fix SSO users being redirected to login page instead of automatic re-login ([#18948](http://projects.theforeman.org/issues/18948))

#### Compute resources and Hosts creation
* Fix controller_key error on VMware host creation on RPM installations ([#18988](http://projects.theforeman.org/issues/18988))

#### Facts, reporting and parameters
* Fix saving of boolean matchers when no value is given ([#18718](http://projects.theforeman.org/issues/18718))

#### Installer and packaging
* Fix missing foreman-prepare-realm script in Debian packages ([#19041](http://projects.theforeman.org/issues/19041))
* Fix missing dependency on rails-observers ([#18929](http://projects.theforeman.org/issues/18929))

#### Web Interface
* Fix internal server error when submitting forms using Internet Explorer ([#18588](http://projects.theforeman.org/issues/18588), [#18587](http://projects.theforeman.org/issues/18587))

#### Various fixes and features
* Fix "progress_report_id" error when deleting non-managed hosts from Discovery ([#15374](http://projects.theforeman.org/issues/15374))

*A full list of changes in 1.14.3 is available via [Redmine](http://projects.theforeman.org/rb/release/227)*

### Release notes for 1.14.2

#### API
* Add missing pxe_loader field to host API response ([#18658](http://projects.theforeman.org/issues/18658))
* Add missing IPv6 address in host interfaces API response ([#18574](http://projects.theforeman.org/issues/18574))
* Fix missing :id documentation for organizations/locations API ([#18582](http://projects.theforeman.org/issues/18582))

#### Compute resources and Hosts creation
* Fix SSH orchestration error when provisioning without Puppet CA ([#3541](http://projects.theforeman.org/issues/3541))
* Fix SSH orchestration error when logging level set to 'error' ([#13769](http://projects.theforeman.org/issues/13769))
* Fix missing CR network list etc. when creating new compute profile ([#18468](http://projects.theforeman.org/issues/18468))
* Fix error during orchestration rollback when creating VMware VMs ([#18366](http://projects.theforeman.org/issues/18366))
* Fix undefined method error during Gentoo image provisioning ([#17866](http://projects.theforeman.org/issues/17866))

#### Proxy and Services
* Fix low default timeout of Puppet class API query, add `api_timeout` configuration option ([#18290](http://projects.theforeman.org/issues/18290))

#### Web Interface
* Fix localized display of multiple plugin authors ([#18511](http://projects.theforeman.org/issues/18511))
* Fix ordering of email notifications when editing users ([#18559](http://projects.theforeman.org/issues/18559))

*A full list of changes in 1.14.2 is available via [Redmine](http://projects.theforeman.org/rb/release/221)*
