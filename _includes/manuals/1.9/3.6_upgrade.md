...
* Updating existing Puppet class overrides from the host or host group forms will
  not update their values, use the Puppet class edit for now
  ([#11807](http://projects.theforeman.org/issues/11807)).
