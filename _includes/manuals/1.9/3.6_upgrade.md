...
* OpenStack compute resources throw tenant related errors
  ([#11023](http://projects.theforeman.org/issues/11023)).
* Extra network interfaces may be added when using compute profiles
  ([#10994](http://projects.theforeman.org/issues/10994)).
