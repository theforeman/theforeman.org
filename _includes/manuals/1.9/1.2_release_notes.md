...
#### API
* Fix lookup of Puppet environments by name ([#12004](http://projects.theforeman.org/issues/12004))
* Fix association of OS to provisioning templates with unwrapped parameters ([#12089](http://projects.theforeman.org/issues/12089))

#### Installer and packaging
* Fix missing lsb-release dependency on installer Debian package ([#12134](http://projects.theforeman.org/issues/12134))
* Pin fog-google for Ruby 1.9 compatibility ([#12015](http://projects.theforeman.org/issues/12015))
* Pin net-ssh for Ruby 1.9 compatibility ([#11980](http://projects.theforeman.org/issues/11980))
* Pin rack-cache for Ruby 1.9 compatibility ([#12074](http://projects.theforeman.org/issues/12074))

#### Puppet and Puppet integration
* Fix YAML/JSON parameter overrides being reformatted on host edit ([#11375](http://projects.theforeman.org/issues/11375))
* Fix Puppet class import error with wrong environment name used ([#11999](http://projects.theforeman.org/issues/11999))
* Fix missing Puppet class handling when environment is not found ([#12151](http://projects.theforeman.org/issues/12151))

#### Web Interface
* Fix multiselects compatibilty with select2 dropdown menus ([#12028](http://projects.theforeman.org/issues/12028))
* Fix ability to save bookmarks for provisioning templates ([#11953](http://projects.theforeman.org/issues/11953))

#### Various fixes and features
* Fix error when using param_true/false template methods ([#11945](http://projects.theforeman.org/issues/11945))
* Fix SELinux policy loading under EL7.2 ([#11934](http://projects.theforeman.org/issues/11934))

*A full list of changes in 1.9.3 is available via [Redmine](http://projects.theforeman.org/rb/release/91)*
