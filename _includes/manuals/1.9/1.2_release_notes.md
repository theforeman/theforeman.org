...
Using /etc/foreman/settings.yaml, the log level can now easily be changed (e.g. to debug) or specific types of logs enabled.  See [How do I enable debugging?](http://projects.theforeman.org/projects/foreman/wiki/Troubleshooting#How-do-I-enable-debugging) for more information.
