...
There are two known bugs with Puppet 3.4.0 and 3.4.1 that prevent the installer from running successfully.  We strongly recommend downgrading to Puppet 3.3.2 in the meantime.  <a href="http://projects.theforeman.org/projects/foreman/wiki/Troubleshooting#Installation-errors-on-Puppet-34x-or-2724">More info</a>.
</div>
