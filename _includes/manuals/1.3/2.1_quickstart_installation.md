...
[The Foreman installer](/manuals/{{foremanver}}/index.html#3.2ForemanInstaller) uses Puppet to install Foreman. This guide assumes that you've already installed Puppet (without a master), but the installer will setup Foreman and the puppet master with Passenger and the [Smart Proxy](/manuals/{{foremanver}}/index.html#4.3SmartProxies) by default.
...
{% highlight bash %}
yum -y install http://yum.theforeman.org/releases/{{foremanver}}/el6/x86_64/foreman-release.rpm
