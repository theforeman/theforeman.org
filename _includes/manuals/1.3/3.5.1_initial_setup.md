...
[foreman_configuration](manuals/{{foremanver}}/index.html#3.5.2ConfigurationOptions)
...
[MySQL](manuals/{{foremanver}}/index.html#3.5.3DatabaseSetup)) please modify the configuration file under *config/database.yml*.
...
[here](manuals/{{foremanver}}/index.html#3.5.3DatabaseSetup)
...
Read [Puppet_Reports](manuals/{{foremanver}}/index.html#3.5.4PuppetReports) to learn how to get your nodes to report to Foreman.
