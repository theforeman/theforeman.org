...
* Fix errors when creating resources via CSV ([#3839](http://projects.theforeman.org/issues/3839))
...
- Full BMC support ([##2853](https://projects.theforeman.org/issues/2853))
