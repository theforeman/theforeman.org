...
Firstly, the default installer setup doesn't give superuser priviledges to the 'foreman' user, which then prevents the prod2dev script from temporarily disabling foreign keys. You'll need to do
