...
This column currently suffers from a [known bug](http://theforeman.org/issues/3846). This bug means this count excludes Hostgroups from final figure.

Under "More" -> "Configuration" -> "Puppet Classes" you will see a column called "Hosts". This column represents the number of hosts the given module/class has been assigned to. Clicking this figure will list the hosts.
