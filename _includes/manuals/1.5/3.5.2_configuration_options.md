...
This boolean options configures wether Foreman will provide support for the JavaScript object notation with padding. When set to _true_ then foreman will allow to pass a callback parameter to the api calls.
