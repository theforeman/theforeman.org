...
Foreman 1.5.1 is security, bug fix and minor enhancement release.  The installer component will remain at version 1.4.3 (Debian/Ubuntu) or 1.4.2 (RPM), and the SELinux policy at version 1.4.4.
