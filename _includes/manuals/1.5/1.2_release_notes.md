...
We strongly recommend that users update to Foreman 1.5.4 as soon as possible due to the security issue that has been fixed in this version.  See the <a href="/security.html">Security advisories</a> page for more information, including mitigations if an upgrade isn't immediately possible.
...
*A full list of changes in 1.5.4 is available via [Redmine](http://projects.theforeman.org/rb/release/26)*
