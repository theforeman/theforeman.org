...
Components include the Foreman web UI, Smart Proxy, Puma, a Puppet Server, and optionally TFTP, DNS and DHCP servers.  It is configurable and the Puppet modules can be read or run in "no-op" mode to see what changes it will make.

#### Supported platforms
* CentOS 7 x86_64
* CentOS 8 x86_64 (except for Katello plugin)
* Debian 10 (Buster), amd64
* Red Hat Enterprise Linux 7, x86_64
* Red Hat Enterprise Linux 8, x86_64 (except for Katello plugin)
