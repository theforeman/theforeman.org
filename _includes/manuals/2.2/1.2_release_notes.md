...
* VNC console connection may fail to connect due to browser security settings. This will be fixed in 2.2.2 and 2.3.0. The patch fixing it can be safely applied manually if needed. ([#31317](https://projects.theforeman.org/issues/31317))
