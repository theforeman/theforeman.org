...
* Add cpu/cores/socket react cmponent ([#29900](https://projects.theforeman.org/issues/29900))
...
* Trends and statistics are now moved to a separate plugin. See the [manual](/plugins/foreman_statistics) of the new Statistics plugin if you wish continue using them. If not, there will be a rake task provided to clean up any unused entries from the database.
