...
#### Dashboard
* disable auto-reload of the dashboard ([#25637](https://projects.theforeman.org/issues/25637))
...
#### Debian/Ubuntu
* Dependency error when running foreman modules without Foreman-installer ([#25716](https://projects.theforeman.org/issues/25716))
...
#### Facts
* Custom boolean facts with false value are not managed by Satellite. ([#25483](https://projects.theforeman.org/issues/25483))
