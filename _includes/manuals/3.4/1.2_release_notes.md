...
* Add options for table preferences API ([#35212](https://projects.theforeman.org/issues/35212))
* Ansible plugin overrides the drop-down menu on the Hostgroups page  ([#35167](https://projects.theforeman.org/issues/35167))
...
* VM creation is broken with libvirt &gt;= 8.0.0 ([#35035](https://projects.theforeman.org/issues/35035))
...
#### Foreman - Rails
* Setting kwarks are ambigous in validation ([#35293](https://projects.theforeman.org/issues/35293))
...
#### Foreman - Smart Proxy
* Capsule upgrade/install fails due to proxy configuration in  'HTTP(S) proxy' in settings ([#34996](https://projects.theforeman.org/issues/34996))
...
* Allow configuring cockpit with multiple origins through satellite-installer
 ([#34943](https://projects.theforeman.org/issues/34943))
