...
* When upgrading from 1.7 with unmanaged hosts (those added from a Puppet run
  or similar), host-specific overrides will be ignored causing incorrect
  configuration ([#10403](http://projects.theforeman.org/issues/10403)).
