...
* foreman_docker users should avoid upgrading, as a bug causes the application
  to crash on startup with RC versions ([#9716](http://projects.theforeman.org/issues/9716))
