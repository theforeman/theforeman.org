...
* Upgrades of existing installations with compute resources configured may
  raise an error during package postinstall, and compute resource passwords
  may need re-entering ([#9771](http://projects.theforeman.org/issues/9771))
* Compute resource passwords are not encrypted in the database ([#9775](http://projects.theforeman.org/issues/9775))
