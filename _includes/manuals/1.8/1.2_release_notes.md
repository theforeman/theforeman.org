...
Traditionally, Foreman stored the primary interface and additional interfaces separately.  Foreman 1.8 now stores a single list of network interfaces for each host, one of which can be marked as the primary interface for the purposes of determining the FQDN and primary IP address.
