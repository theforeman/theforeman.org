...
MariaDB/MySQL users should do the similar:

    foreman-maintain service stop --exclude mysql
    mysqlcheck --optimize --all-databases
    foreman-maintain service start

On platforms where foreman-maintain is not available, stop all Foreman-related services except PostgreSQL or MySQL.
