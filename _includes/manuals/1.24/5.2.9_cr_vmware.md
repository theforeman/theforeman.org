...
* To get status "Installed" in the UI, the provisioned host have to run a finish script. There are templates like "built" located in "Provision Templates", giving a example how to do this.
