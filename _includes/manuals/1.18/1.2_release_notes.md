...
* XSS on all pages that use breadcrumbs ([#25169](https://projects.theforeman.org/issues/25169))
...
### API
* Fix performance regression on API ([#24712](https://projects.theforeman.org/issues/24712))

#### Compute Resources
* Compute resource tab loading ([#24673](https://projects.theforeman.org/issues/24673))

#### Compute Resources - VMware
* Update Foreman Fog-Vsphere select_nic method ([#23961](https://projects.theforeman.org/issues/23961))
* fog-vsphere 2.3 vsphere nic selection ([#24571](https://projects.theforeman.org/issues/24571))

#### Puppet integration
* Cast all lookup keys and values ([#24640](https://projects.theforeman.org/issues/24640))
* Cast ommited default with merge overrides ([#24640](https://projects.theforeman.org/issues/24640))

#### Roles and Permissions
* Don't remove permissions from default roles ([#24697](https://projects.theforeman.org/issues/24697))

#### Organizations and Locations
* Fix bulk taxonomy update with scoped_search ([#24702](https://projects.theforeman.org/issues/24702))

#### Other
* Pin factory bot ([#24654](https://projects.theforeman.org/issues/24654))
* Pin react-bootstrap ([#24657](https://projects.theforeman.org/issues/24657))
...
*A full list of changes in {{page.version}} is available via [Redmine](https://projects.theforeman.org/issues?set_filter=1&sort=id%3Adesc&status_id=closed&f[]=cf_12&op[cf_12]=%3D&v[cf_12][]=261)*

### Release notes for 1.18.0 - Features
...
### Release notes for 1.18.0 - Bug Fixes
