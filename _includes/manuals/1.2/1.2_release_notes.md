...
* Pin gettext_i18n_rails version for Ruby 1.8 support ([#3167](http://projects.theforeman.org/issues/3167))
...
* Fix privilege escalation as hosts API wasn't restricted to user's permitted hosts (CVE-2013-4182, [#2863](http://projects.theforeman.org/issues/2863))
