...
* Fix remote code execution in Foreman via bookmarks storage (CVE-2013-2121, [#](http://projects.theforeman.org/issues/))
* Fix role privilege escalation by users with create/edit user privileges (CVE-2013-2113, [#](http://projects.theforeman.org/issues/))
