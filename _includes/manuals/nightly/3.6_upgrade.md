...
<div class="upgrade_os upgrade_os_debian12 upgrade_os_debian13 upgrade_os_ubuntu2204 upgrade_os_ubuntu2404">
{% highlight bash %}
...
<div class="upgrade_os upgrade_os_debian13">
{% highlight bash %}
deb http://deb.theforeman.org/ trixie {{ page.version }}
deb http://deb.theforeman.org/ plugins {{ page.version }}
{% endhighlight %}
</div>
...
<div class="upgrade_os upgrade_os_ubuntu2404">
{% highlight bash %}
deb http://deb.theforeman.org/ noble {{ page.version }}
deb http://deb.theforeman.org/ plugins {{ page.version }}
{% endhighlight %}
</div>
