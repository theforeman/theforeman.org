...
Packages for Debian 7 (Wheezy) and Ubuntu 12.04 (Precise Pangolin) are no longer supplied, please update to a newer OS version to update Foreman to 1.12. Lastly, EL6 is now deprecated - while fully supported in 1.12, Foreman 1.13 will not support it and a [migration to EL7](manuals/1.12/index.html#5.5Backup,RecoveryandMigration) will be necessary.

### Release notes for 1.12.4

#### Security
* Fix SELinux policy to build on EL6.5 with OpenStack Neutron port ([#16263](http://projects.theforeman.org/issues/16263))

#### Web Interface
* Fix SQL error when searching on dashboard ([#16704](http://projects.theforeman.org/issues/16704))
* Fix SQL error shown accessing Puppet tab on smart proxies ([#16627](http://projects.theforeman.org/issues/16627))
* Fix SQL error when searching facts by host group ([#15543](http://projects.theforeman.org/issues/15543))

*A full list of changes in 1.12.4 is available via [Redmine](http://projects.theforeman.org/rb/release/194)*
...
* Fix interfaces APIs error for non-admin users with limited "host" filters ([#16219](http://projects.theforeman.org/issues/16219))
* Fix exception when editing role filters with org/location associations ([#14101](http://projects.theforeman.org/issues/14101))

#### Compute resources and Hosts creation
* Fix host build checker to not check the status of unused host group smart proxies ([#16197](http://projects.theforeman.org/issues/16197))
* Fix access to OS password hash algorithm from templates ([#16416](http://projects.theforeman.org/issues/16416))
...
* puppet-puppet, version 5.0.1 ([CHANGELOG](https://github.com/theforeman/puppet-puppet/blob/5.0.1/CHANGELOG.md#changelog))

#### Puppet and Puppet integration
* Fix foreman-prepare-realm when multiple "server" lines exist in config file ([#16410](http://projects.theforeman.org/issues/16410))

#### Web Interface
* Fix dashboard latest event widget loading speed with many hosts ([#16238](http://projects.theforeman.org/issues/16238))
  * Due to regressions, this change was reverted in 1.12.4
* Fix searching of Puppet classes by `hostgroup` or `config_group` ([#16483](http://projects.theforeman.org/issues/16483))
* Fix search auto-complete of audits by hostname ([#16211](http://projects.theforeman.org/issues/16211))

#### Various fixes and features
* Fix resource creation when within a specific org/location context ([#16389](http://projects.theforeman.org/issues/16389))
* Fix database migration when unattended mode is disabled ([#14468](http://projects.theforeman.org/issues/14468))

*A full list of changes in 1.12.3 is available via [Redmine](http://projects.theforeman.org/rb/release/181)*

### Release notes for 1.12.2

#### API
* Fix duplicate smart class parameters when present in multiple environments ([#15833](http://projects.theforeman.org/issues/15833))
* Fix missing documentation for admin usergroups attribute ([#12488](http://projects.theforeman.org/issues/12488))

#### Authentication and Authorization
* Fix editing of cloned built in role ([#15108](http://projects.theforeman.org/issues/15108))
* Fix access to help pages for non-admin users ([#14301](http://projects.theforeman.org/issues/14301))
* Fix image authorization search filter when limited to compute resource ([#16196](http://projects.theforeman.org/issues/16196))

#### CLI

##### foreman-debug
* Add host query to verify forward/reverse DNS ([#15921](http://projects.theforeman.org/issues/15921))

#### Compute resources and Hosts creation
* Support oVirt 4.0 compute resource via API v3 ([#15560](http://projects.theforeman.org/issues/15560))
* Fix automatic IP assignment to occur for non-primary interfaces over API ([#16061](http://projects.theforeman.org/issues/16061))
* Fix after_build callbacks to execute when debugging is disabled ([#16199](http://projects.theforeman.org/issues/16199))

#### Installer and packaging
* Pin gettext_i18n_rails for Ruby 2.0.0 compatibility ([#16083](http://projects.theforeman.org/issues/16083))
* Pin fast_gettext for Ruby 2.0.0 compatibility ([#15953](http://projects.theforeman.org/issues/15953))

#### Proxy and Services
* Fix UTF-8 encoding errors when updating FreeIPA realm entries ([#10581](http://projects.theforeman.org/issues/10581))
* Fix ambiguous DHCP-related log messages to include DHCP context ([#15944](http://projects.theforeman.org/issues/15944))
* Fix intermittent DHCP server test failure ([#15791](http://projects.theforeman.org/issues/15791))
* Pin json_pure for Ruby 1.8/1.9 compatibility ([#15865](http://projects.theforeman.org/issues/15865))

#### Puppet and Puppet integration
* Revert change to location/organization names in ENC output, moved to `location_full` ([#15977](http://projects.theforeman.org/issues/15977))
* Fix multi-line YAML text to be compatible with Ruby 1.8.7 clients ([#13813](http://projects.theforeman.org/issues/13813))

#### Security
* Fix host interface form to escape interface identifiers to prevent stored XSS ([CVE-2016-6320](/security.html#2016-6320), [#16022](http://projects.theforeman.org/issues/16022))
* Fix form helpers to correctly escape labels preventing stored XSS in plugins ([CVE-2016-6319](/security.html#2016-6319), [#16024](http://projects.theforeman.org/issues/16024))
* Update Ruby on Rails to 4.2.7.1 for security fixes ([#16085](http://projects.theforeman.org/issues/16085))
* Fix potential reflective XSS in smart variable form validation ([#16020](http://projects.theforeman.org/issues/16020))
* Fix SELinux policy to permit access to OpenStack Neutron ([#15640](http://projects.theforeman.org/issues/15640))
  * Due to [an issue with EL6 builds](http://projects.theforeman.org/issues/16263), foreman-selinux has only been updated on EL7 and F24 with this fix and remains at version 1.12.1 on EL6

#### Web Interface
* Fix multiple navigation bars when power status for host cannot be retrieved ([#15996](http://projects.theforeman.org/issues/15996))

#### Various fixes and features
* Fix domain_id related error when receiving reports, uploading facts etc. for hosts ([#14516](http://projects.theforeman.org/issues/14516), [#14518](http://projects.theforeman.org/issues/14518))

*A full list of changes in 1.12.2 is available via [Redmine](http://projects.theforeman.org/rb/release/175)*
...
#### Authentication and Authorization
* Fix notification for missing email address to be an error popup ([#15466](http://projects.theforeman.org/issues/15466))
* Fix access to the About page for non-admin users ([#15622](http://projects.theforeman.org/issues/15622))
* Fix default Viewer role to only list permissions starting with "view_" ([#15276](http://projects.theforeman.org/issues/15276))

#### CLI

##### foreman-debug
* Fix error shown when foreman-rake is run without options ([#15684](http://projects.theforeman.org/issues/15684))

#### Compute resources and Hosts creation
* Fix updating of SSL CA for existing oVir compute resources ([#15345](http://projects.theforeman.org/issues/15345))
* Fix merging of volume attributes during Libvirt host creation ([#15372](http://projects.theforeman.org/issues/15372))
* Fix VMware host creation to only create CDROM when checked ([#15625](http://projects.theforeman.org/issues/15625))
* Fix bad error message for invalid MAC address during host creation ([#14955](http://projects.theforeman.org/issues/14955))
* Fix code behind Puppet environment selector to not interfere with plugins ([#11749](http://projects.theforeman.org/issues/11749))
* Fix missing `@mediapath` variable when generating SUSE provisioning templates ([#15709](http://projects.theforeman.org/issues/15709))
* Fix unusable interface modal window during compute resource selection ([#15355](http://projects.theforeman.org/issues/15355))

#### Installer and packaging
* Fix missing smart proxy migration/upgrade state file in Debian package ([#15641](http://projects.theforeman.org/issues/15641))
* Fix blocking Debian init script when smart proxy daemon is disabled ([#7920](http://projects.theforeman.org/issues/7920))
* Fix missing variables in auth_kerb.conf Apache config when using IPA ([#15642](http://projects.theforeman.org/issues/15642))
* Pin google-api-client to 0.8.x ([#15576](http://projects.theforeman.org/issues/15576))
* Pin rabl to 0.12.x ([#15712](http://projects.theforeman.org/issues/15712))

Installer modules have been updated, see their respective changelogs for more detailed notes:

* puppet-foreman, version 5.2.2 ([CHANGELOG](https://github.com/theforeman/puppet-foreman/blob/5.2.2/CHANGELOG.md#changelog))

#### Proxy and Services
* Fix error setting unknown PXEClient option when creating MS DHCP reservations ([#13575](http://projects.theforeman.org/issues/13575))
* Fix short ping timeout from MS DHCP provider ([#15373](http://projects.theforeman.org/issues/15373))
* Fix file handle cleanup in MS DHCP provider ([#15348](http://projects.theforeman.org/issues/15348))
* Fix case insensitivity on MS DNS (dnscmd) zone names ([#15341](http://projects.theforeman.org/issues/15341))

#### Puppet and Puppet integration
* Fix fact importer to always import facts without checking last compile time ([#15525](http://projects.theforeman.org/issues/15525))
* Fix PuppetCA certificate listing page when some certificates are missing dates ([#15471](http://projects.theforeman.org/issues/15471))
* Fix syntax/formatting of hash values in smart matchers when editing ([#15718](http://projects.theforeman.org/issues/15718))
* Fix new lines being stripped from end of smart matcher values ([#15534](http://projects.theforeman.org/issues/15534))
...
#### Web Interface
* Fix dashboard search for enabled attribute when Discovery plugin is installed ([#15773](http://projects.theforeman.org/issues/15773))
* Fix host search links on the host group link to be quoted ([#15391](http://projects.theforeman.org/issues/15391))
* Fix org/location edit error for non-admin user with search filters ([#15278](http://projects.theforeman.org/issues/15278))
* Fix small size of input components when editing settings ([#15140](http://projects.theforeman.org/issues/15140))
* Fix styling of import classes button on environments/classes pages ([#15657](http://projects.theforeman.org/issues/15657))

#### Various fixes and features
* Fix copyright statement errors in project LICENSE file ([#14953](http://projects.theforeman.org/issues/14953))
* Fix poor reports:expire performance due to unnecessary database join ([#15675](http://projects.theforeman.org/issues/15675))
...
*A full list of changes in 1.12.1 is available via [Redmine](http://projects.theforeman.org/rb/release/161)*
...
* Fix SQL error when viewing details of a facts trend ([#14879](http://projects.theforeman.org/issues/14879))
...
### Deprecations
* EL6 (CentOS, RHEL etc.) support is deprecated - while fully supported in 1.12, Foreman 1.13 will not support it and a [migration to EL7](manuals/1.12/index.html#5.5Backup,RecoveryandMigration) will be necessary.
...
* ENC/Puppet users of the `location`/`organization` parameters should be aware they are now the full titles, not short names.
  * Correction: 1.12.2 has reverted this change as it was deemed to be too incompatible, but versions 1.12.0 and 1.12.1 contained it.
