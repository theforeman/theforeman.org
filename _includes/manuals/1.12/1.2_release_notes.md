...
The [Puppet Compatibility](/manuals/1.12/index.html#3.1.2PuppetCompatibility) section of the manual now lists supported versions of Puppet and Puppet Server.
