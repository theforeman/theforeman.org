...
No updated foreman-installer package is supplied for EL6 or Ubuntu 12.04 (Precise) in this release due to a bug in the build process, and the resulting packages not being compatible with Puppet 2.7. No change was made to the installer in this release, so the 1.10.3 installer will work identically.
...
*A full list of changes in 1.10.4 is available via [Redmine](http://projects.theforeman.org/rb/release/152)*
...
*A full list of changes in 1.10.3 is available via [Redmine](http://projects.theforeman.org/rb/release/145)*

### Release notes for 1.10.2

#### API
* Fix undefined method lookup_value_match error during host creation ([#11346](http://projects.theforeman.org/issues/11346))

#### Authentication and Authorization
* Fix exception editing or creating role filters ([#13515](http://projects.theforeman.org/issues/13515))

#### CLI

##### foreman-debug
* Fix script exit code when upload is disabled ([#13442](http://projects.theforeman.org/issues/13442))

#### Compute resources and Hosts creation
* Fix population of EC2 security groups selection boxes ([#6535](http://projects.theforeman.org/issues/6535))
* Fix logging of stderr from SSH finish scripts ([#13401](http://projects.theforeman.org/issues/13401))
* Fix finish script SSH login with challenge response auth ([#13297](http://projects.theforeman.org/issues/13297))
* Fix OpenStack-related error when powering on/off GCE hosts ([#12187](http://projects.theforeman.org/issues/12187))
* Fix missing reboot power action for virtual machines ([#13430](http://projects.theforeman.org/issues/13430))
* Fix safemode compatibility of kernel/initrd paths in Debian/SUSE iPXE templates ([#12791](http://projects.theforeman.org/issues/12791))
* Fix kickstart networking template to set up EL5 compatible device lines ([#13724](http://projects.theforeman.org/issues/13724))
* Fix RHN register snippet to enable repos correctly on RHEL5 ([#13684](http://projects.theforeman.org/issues/13684))

#### Proxy and Services
* Fix each_line error when parsing native MS DHCP command output ([#13346](http://projects.theforeman.org/issues/13346))
* Fix intermittent native MS DHCP command output parsing problems ([#13129](http://projects.theforeman.org/issues/13129))

#### Puppet and Puppet integration
* Fix parsing of Puppet manifests containing Unicode characters ([#13219](http://projects.theforeman.org/issues/13219))
* Fix overriding of parameters with truncated names on host form ([#13369](http://projects.theforeman.org/issues/13369))
* Fix Puppet CA certificate management with Puppet 4/AIO paths ([#13522](http://projects.theforeman.org/issues/13522))

#### Security
* Fix SELinux labeling of Passenger /var/run after log rotation ([#13041](http://projects.theforeman.org/issues/13041))

#### Web Interface
* Fix dashboard widget width in German locale ([#13375](http://projects.theforeman.org/issues/13375))
* Fix resizing of template editor in full screen mode ([#13247](http://projects.theforeman.org/issues/13247))
* Fix hidden "reset zoom" button on charts ([#12909](http://projects.theforeman.org/issues/12909))

#### Various fixes and features
* Fix migration of primary interface name from Foreman 1.7 or older ([#13745](http://projects.theforeman.org/issues/13745))
* Fix lookup_value_matcher migration error from Foreman 1.8 or older ([#12669](http://projects.theforeman.org/issues/12669))
* Fix default Fedora installation media URL ([#13341](http://projects.theforeman.org/issues/13341))

*A full list of changes in 1.10.2 is available via [Redmine](http://projects.theforeman.org/rb/release/123)*
