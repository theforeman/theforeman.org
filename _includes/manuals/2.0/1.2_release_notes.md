...
* remove usage of Rainbow in templates render task ([#28001](https://projects.theforeman.org/issues/28001))
...
#### Tests
* smart proxy version comparison test failes due to 2.0 version bump ([#28645](https://projects.theforeman.org/issues/28645))
