...
Since Foreman integrates with Puppet heavily, it is recommended to use the Puppet Certificate Authority (CA) to secure proxy access.  See the _Securing communications with SSL_ section for more advanced installations (multiple or internal CAs).
