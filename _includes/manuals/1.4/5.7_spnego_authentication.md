...
On the Foreman machine, we tell Foreman that it is OK to trust the authentication done by Apache by adding to /etc/foreman/settings.yaml or under *Adminster > Settings*:
{% highlight yaml %}
