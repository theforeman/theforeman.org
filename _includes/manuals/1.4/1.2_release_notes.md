...
* When Foreman is installed under a prefix such as /foreman, menu items link to / instead of the prefix ([#3903](http://projects.theforeman.org/issues/3903))
* On Debian 6 (Squeeze) or Ubuntu 12.04, foreman-installer's interactive mode will raise an error with highline.  Use the non-interactive mode as a workaround.
