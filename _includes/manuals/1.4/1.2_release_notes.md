...
# [#3903](http://projects.theforeman.org/issues/3903): menu URLs when relative URL root is used links to /.  When Foreman is installed under a prefix, such as /foreman, the menu links to / instead of the prefix.
