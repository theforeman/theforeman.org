...
* Remove APIv2 "catch all" route so plugins can extend it (#3974)
...
* Enable auditing for auth sources, bookmarks, domains, images, roles, proxies, subnets and usergroups (#3975)
...
* Add Junos ZTP provisioning support for Juniper network devices (#3906)
...
* Add user data (i.e. cloud-init) support for image-based CRs [[EC2 documentation](/manuals/1.4/index.html#5.2.3EC2Notes), [OpenStack documentation](/manuals/1.4/index.html#5.2.6OpenStackNotes)] (#3927)
...
* Fix `@static` support in non-kickstart templates (#4020)
...
* Add dnscmd (Windows AD) DNS provider for creating static records (#3991)
...
* Add puppet dependency to the Gemfile (#3966)
...
* foreman-gce package added for Google Compute Engine (GCE) support (#3050, #3617)
* RHSCL / Software Collections now used instead of ruby193 rebuild (#3989)
...
* Installer changed to use puppetlabs-apache module (#3972)
...
* Update Rails to 3.2.16 (#4021)
* 'rr' dependency removed (#3597)
* 'coffeescript' dependency removed (#3992)
...
* foreman module changes:
   * depend on puppetlabs-apache instead of theforeman-apache (#3972)
...
* Add notice and above level filter to report view (#3571)
...
* Change environments page to refer to Puppet environments (#3709)
* Fix title text for libvirt volume deletion (#3932)
* Update application template layout for best practices (#3872)
* Update image username help text (#3967)
* Fix disabling of items in multi-select boxes (#3911)
* Rename i18n function for compatibility with underscore.js (#3984)
...
* Fix positioning of power status on Rackspace VMs (#4024)
...
* Add rsync upload support to foreman-debug (#3973)
* Fix inclusion of installer and proxy logs in foreman-debug (#3958)
* Fix random directory name in foreman-debug (#2613)
...
* Fix OS class overriding of class methods (#3962)
