...
#### Easily remove oVirt resources

With oVirt being deprecated, you may use a new rake task that will remove them for you.
...
* replace ToastNotification in editor with an alert ([#38244](https://projects.theforeman.org/issues/38244))
...
* Ubuntu 20.04 Autoinstall provisioning template snapshots do not include NIC ([#38222](https://projects.theforeman.org/issues/38222))
* Installation of previously installed package fails ([#38200](https://projects.theforeman.org/issues/38200))
...
#### Foreman - Logging
* Tweak the OIDC issuer message ([#38262](https://projects.theforeman.org/issues/38262))

#### Foreman - Organizations and Locations
* Location creation is very slow unless Administrator checkbox is set ([#38201](https://projects.theforeman.org/issues/38201))
...
* Core - update to Patternfly 5 ([#37746](https://projects.theforeman.org/issues/37746))

#### Installer
* Install Hammer CLI plugin for foreman_bootdisk via foreman-installer ([#38228](https://projects.theforeman.org/issues/38228))
