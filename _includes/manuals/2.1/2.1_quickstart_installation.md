...
Over the last year, Foreman community members have been open-sourcing Red Hat documentation to make more comprehensive guides available to Foreman users. At the moment, the following guides have been migrated to a work-in-progress [Foreman and Katello documentation site](http://docs.theforeman.org/web/). This project is not yet complete, but you might find useful information in some of the following guides:  

* [Provisioning Guide](http://docs.theforeman.org/guides/build/doc-Provisioning_Guide/index-foreman.html)
* [Administering Foreman Guide](http://docs.theforeman.org/guides/build/doc-Administering_Red_Hat_Satellite/index-foreman.html)
* [Managing Hosts Guide](http://docs.theforeman.org/guides/build/doc-Managing_Hosts/index-foreman.html)
* [Content Management Guide](http://docs.theforeman.org/guides/build/doc-Content_Management_Guide/index-foreman.html)
* [Configuring Smart Proxies with a Load Balancer](http://docs.theforeman.org/guides/build/doc-Configuring_Load_Balancer/index-foreman.html)
