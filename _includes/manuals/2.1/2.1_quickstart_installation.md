...
If you want to manage content (for example, RPMs, Kickstart trees, ISO and KVM images, OSTree content, and more) with Foreman or you are a new user unfamiliar with all of Foreman's capabilities, please follow the [Katello]({{ site.baseurl }}plugins/katello) installation instructions. Installing Katello on top of an existing Foreman is unsupported.
