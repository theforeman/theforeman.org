...
#### API
* Foreman API host facts returns facts two times ([#25008](https://projects.theforeman.org/issues/25008))
...
#### RPMs
* foreman-installer candlepin java version ([#25686](https://projects.theforeman.org/issues/25686))
...
*A full list of changes in {{page.version}} is available via [Redmine](https://projects.theforeman.org/issues?set_filter=1&sort=id%3Adesc&status_id=closed&f[]=cf_12&op[cf_12]=%3D&v[cf_12][]=977)*
...
*A full list of changes in 1.20.3 is available via [Redmine](https://projects.theforeman.org/issues?set_filter=1&sort=id%3Adesc&status_id=closed&f[]=cf_12&op[cf_12]=%3D&v[cf_12][]=1005)*
