...
The Foreman installation will be accessible after installation at `https://fqdn/` with a default username/password of "admin" and "changeme".

To complete the installation, log into Foreman, click on More, Configuration, Smart Proxies and add a new proxy with the URL `https://fqdn:3000/`.  This will enable Puppet class imports from your new puppet master.
