...
1. Update the ENC script
   [node.rb](https://github.com/theforeman/puppet-foreman/blob/master/templates/external_node_v1.rb.erb)
and report processor
[foreman.rb](https://github.com/theforeman/puppet-foreman/blob/master/templates/foreman-report_v1.rb.erb) using the foreman-installer, or copy its templates and update:
