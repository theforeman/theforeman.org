...
<p>
  ...
  <select id="operatingSystems">
     ...
     <option value="f26">Fedora 26</option>
...
{% highlight bash %}
yum install -y https://fedorapeople.org/groups/katello/releases/yum/{{ page.version }}/client/f27/x86_64/katello-client-repos-latest.rpm
{% endhighlight %}
</div>
