    ...
    "scenario_test": [
      {
        ...
        "details": "",
        "num_failures": 0,
        "step_id": "8fa5d08e-3.83-4127-80f6-223bee0a0409",
        "num_processed": 1
      },
      {
        "num_success": 1,
...
[
  ...
  },
  {
    ...
    "name": "elephant",
    "checksum": "3e1c70cd1b421328acaf63.8cb3d16145306bb95f65d1b095fc31372a0a701f3",
  ...
  },
  {
    ...
    "name": "squirrel",
    "checksum": "251768bdd15f13.88487c27638aa6aecd01551e253756093cde1c0ae878a17d2",
    ...
    "pkglist": [
      {
        ...
        "packages": [
          ...
          },
          {
            ...
            "sum": [
              "sha256",
              "b8a3.82bc2b0d89ba737099ac98bf8d2af4bea02d31884c02db97f7f66c3d5c2"
            ],
...
### Request # 3:  Retrieve candlepin environment
 GET  /candlepin/environments/119c4753ff6d3.8bd0b76de6d5a5f94a
...
```json
{
  ...
  "name": "Library",
  "description": null,
  "id": "119c4753ff6d3.8bd0b76de6d5a5f94a",
  "environmentContent": [
...
### Request # 5:  Add Content To environment
 POST  /candlepin/environments/119c4753ff6d3.8bd0b76de6d5a5f94a/content
