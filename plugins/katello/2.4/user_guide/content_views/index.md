...
Note that all of the actions below can also done with [hammer, the CLI tool](/plugins/katello/{{ page.version }}/cli/index.html), and examples are given at the end of each section.
