...
Katello 3.10 supports upgrades from version 3.8 and Puppet version 4.  For users transitioning from versions prior to 3.8, first [upgrade to Katello 3.8](/plugins/katello/3.8/upgrade/), [upgrade Puppet to version 4](https://theforeman.org/plugins/katello/3.8/upgrade/puppet.html), and then proceed to upgrade to Katello 3.10 following the instructions below.
