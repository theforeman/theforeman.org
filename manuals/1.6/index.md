---
layout: manual
title: Foreman 1.6 Manual
version: 1.6
---

# 1. {{ page.title }}
{% include manuals/1.6/1.1_architecture.md %}
{% include manuals/1.6/1.2_release_notes.md %}
...
{% include manuals/1.6/2.2_quickstart_puppet.md %}

# 3. Installing Foreman
{% include manuals/1.6/3_installing_foreman.md %}
## 3.1 System Requirements
{% include manuals/1.6/3.1_system_requirements.md %}
### 3.1.1 Supported Platforms
{% include manuals/1.6/3.1.1_supported_platforms.md %}
### 3.1.2 Puppet Compatibility
{% include manuals/1.6/3.1.2_puppet_versions.md %}
### 3.1.3 Firewall Configuration
{% include manuals/1.6/3.1.3_firewall_configuration.md %}
## 3.2 Foreman Installer
{%include manuals/1.6/3.2_foreman_installer.md %}
### 3.2.1 Installation
{%include manuals/1.6/3.2.1_installation.md %}
### 3.2.2 Installer Options
{%include manuals/1.6/3.2.2_installer_options.md %}
### 3.2.3 Installation Scenarios
{%include manuals/1.6/3.2.3_installation_scenarios.md %}
## 3.3 Install From Packages
{%include manuals/1.6/3.3_install_from_packages.md %}
### 3.3.1 RPM Packages
{%include manuals/1.6/3.3.1_rpm_packages.md %}
### 3.3.2 Software Collections
{%include manuals/1.6/3.3.2_software_collections.md %}
### 3.3.3 Debian Packages
{%include manuals/1.6/3.3.3_debian_packages.md %}
## 3.4 Install From Source
{%include manuals/1.6/3.4_install_from_source.md %}
## 3.5 Configuration
{%include manuals/1.6/3.5_configuration.md %}
### 3.5.1 Initial Setup
{%include manuals/1.6/3.5.1_initial_setup.md %}
### 3.5.2 Configuration Options
{%include manuals/1.6/3.5.2_configuration_options.md %}
### 3.5.3 Database Setup
{%include manuals/1.6/3.5.3_database_setup.md %}
### 3.5.4 Puppet Reports
{%include manuals/1.6/3.5.4_puppet_reports.md %}
### 3.5.5 Facts and the ENC
{%include manuals/1.6/3.5.5_facts_and_the_enc.md %}
### 3.5.6 CLI
{%include manuals/1.6/3.5.6_cli.md %}
## 3.6 Upgrade
{%include manuals/1.6/3.6_upgrade.md %}
...
{%include manuals/1.6/4.1.2_roles_and_permissions.md %}
### 4.1.3 Trends
...
### 4.2.1 Environments
{%include manuals/1.6/4.2.1_puppet_envs.md %}
### 4.2.2 Classes
{%include manuals/1.6/4.2.2_puppet_classes.md %}
### 4.2.3 Parameters
{%include manuals/1.6/4.2.3_puppet_params.md %}
### 4.2.4 Smart Variables
{%include manuals/1.6/4.2.4_smart_vars.md %}
### 4.2.5 Parameterized Classes
{%include manuals/1.6/4.2.5_param_classes.md %}

## 4.3 Smart Proxies
{%include manuals/1.6/4.3_smartproxy.md %}
...
{%include manuals/1.6/5.2_compute_resources.md %}
### 5.2.1 Using Compute Resources
{%include manuals/1.6/5.2.1_cr_using.md %}
### 5.2.2 Using Compute Profiles
{%include manuals/1.6/5.2.2_cr_profiles.md %}
### 5.2.3 EC2 Notes
{%include manuals/1.6/5.2.3_cr_ec2.md %}
### 5.2.4 Google Compute Engine Notes
{%include manuals/1.6/5.2.4_cr_gce.md %}
### 5.2.5 Libvirt Notes
{%include manuals/1.6/5.2.5_cr_libvirt.md %}
### 5.2.6 OpenStack Notes
{%include manuals/1.6/5.2.6_cr_openstack.md %}
### 5.2.7 oVirt / RHEV Notes
{%include manuals/1.6/5.2.7_cr_ovirt.md %}
### 5.2.8 Rackspace Notes
{%include manuals/1.6/5.2.8_cr_rackspace.md %}
### 5.2.9 VMware Notes
{%include manuals/1.6/5.2.9_cr_vmware.md %}

## 5.3 Install Locations
{%include manuals/1.6/missing.html %}
## 5.4 Securing Communications with SSL
{%include manuals/1.6/5.4_communications.md %}
### 5.4.1 Securing Puppet Master Requests
{%include manuals/1.6/5.4.1_comms_puppetmaster.md %}
### 5.4.2 Securing Smart Proxy Requests
{%include manuals/1.6/5.4.2_comms_proxy.md %}
## 5.5 Backup, Recovery and Migration
{%include manuals/1.6/5.5_backup_and_recovery.md %}
### 5.5.1 Backup
{%include manuals/1.6/5.5.1_backup.md %}
### 5.5.2 Recovery
{%include manuals/1.6/5.5.2_recovery.md %}
...
{%include manuals/1.6/5.7.4_populate_users_attributes.md %}
